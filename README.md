...
| **Arp** | Notas do acorde em Up / Down / Up-Down / Down-Up / Converge / Random — e agora uma **figura que se repete**, que é o que torna um arpejo reconhecível. O percurso é decidido uma vez e guardado como *posições*, não como notas: a posição 0 é a fundamental do acorde que estiver soando, 1 a terça, 2 a quinta, e daí em diante as mesmas notas uma oitava acima. O movimento é idêntico sobre cada acorde enquanto as notas acompanham a harmonia — dois compassos sobre o mesmo acorde saem iguais. O **Craft** varia as repetições, e o **New idea** troca a figura: onde a corrida começa e até onde ela alcança. Os acentos seguem o groove que estiver embaixo. |
| **Pattern** | Uma figura inventada uma vez e **repetida**, com a harmonia se movendo por baixo. É o que um arpejo não consegue ser: o arpejo lê o acorde e o soletra, então quando o acorde muda as notas mudam e nada sobrevive ao compasso. Aqui a figura é decidida primeiro e o resto acompanha — a forma *é* a parte. O contorno é andado em **graus da escala**, não em semitons, então não existe maneira de ele sair do tom: isso é como ele é construído, não um filtro passado depois. Com biblioteca aprendida, o ritmo vem de um compasso real do seu acervo — com a velocidade e a duração de cada semicolcheia, que é a maior parte do que separa uma figura que respira de uma grade que marca. O **Follow** decide o quanto cada repetição cede ao acorde: embaixo ela mantém as notas dela, em cima é puxada para as notas do acorde e vira um arpejo vestindo o ritmo da figura. O **Craft** varia as repetições para não virar loop — e o primeiro compasso é sempre a figura literal, porque você precisa ouvi-la antes de ouvi-la mudar. |
...
- **Craft** também vale para o **Arp** e o **Pattern**: é o quanto cada
  repetição se afasta da figura. Em 0 o compasso se repete literalmente. E o
  primeiro compasso é sempre a figura, seja qual for o valor — você precisa
  ouvi-la antes de ouvi-la mudar.
- **Follow** só existe para o **Pattern**: o quanto a figura se dobra ao acorde
  embaixo dela. Em 0 ela mantém as próprias notas; no máximo cada nota é puxada
  para o acorde. No meio, só o que bate de fato — um semitom contra uma nota do
  acorde — cede; nota de passagem fica, que é como melodia sempre funcionou.
